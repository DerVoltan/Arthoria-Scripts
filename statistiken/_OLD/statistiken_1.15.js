...
var statisticsVersion = 1.15; //GM_info.script.version won't work with opera12
...
function statisticsInternalVersioncontrol(){
  if(statisticsVersion != data["options"]["character"]["scriptversion"]){
    ...
    if(installedversion < 1.15){
      installedversion = 1.15;
    }
...
function getGlyphboardType(id){ // TODO
  var allGlyphboards = {
    4435: "Holz",
    4436: "Stein",
    4437: "Kufer",
